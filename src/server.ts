...
var transformationType = new graphql.GraphQLObjectType({
  ...
  fields: {
    ...
    transformedEZASuperAttack: { type: GraphQLString },
    transformedUltraSuperAttack: { type: GraphQLString },
    transformedEZAUltraSuperAttack: { type: GraphQLString },
    transformedPassive: { type: GraphQLString },
    transformedEZAPassive: { type: GraphQLString },
...
var characterType = new graphql.GraphQLObjectType({
  ...
  fields: {
    ...
    ezaSuperAttack: { type: GraphQLString },
    ultraSuperAttack: { type: GraphQLString },
    ezaUltraSuperAttack: { type: GraphQLString },
    passive: { type: GraphQLString },
    ezaPassive: { type: GraphQLString },
    activeSkill: { type: GraphQLString },
    activeSkillCondition: { type: GraphQLString },
    ezaActiveSkill: { type: GraphQLString },
    ezaActiveSkillCondition: { type: GraphQLString },
